...
public class DatabaseHibernateLocalPlantCacheUtil {

    @Getter(lazy = true)
    private static final DatabaseHibernateLocalPlantCacheUtil instance = new DatabaseHibernateLocalPlantCacheUtil();
    ...
    public void setup() {
        ...
        try {
            ...
            pluginConfig.getHibernateConfigLocalPlantCache().forEach(configuration::setProperty);
